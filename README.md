...
This script streamlines package updates for both Debian, Red Hat and Arch-based Linux distributions. With a single command, it updates all system packages. aIt checks if each package manager is installed on the system before attempting updates and provides options for non-interactive updates and help. 
